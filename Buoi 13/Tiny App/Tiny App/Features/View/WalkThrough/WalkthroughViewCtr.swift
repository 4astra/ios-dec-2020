...
class WalkthroughViewCtr: UIViewController {
    ...
    @IBAction func doLogin(_ sender: Any) {
        ...
        if let authBoard = UIStoryboard.instanceWith(name: "Authen"), let loginViewCtr = authBoard.instantiateViewController(withIdentifier: "LoginViewController") as? LoginViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if let tempsPageViewCtr = segue.destination as? MyPageViewCtr {
            ...
            let v1 = storyBoard.instantiateViewController(withIdentifier: "v1")
            let v2 = storyBoard.instantiateViewController(withIdentifier: "v2")
            let v3 = storyBoard.instantiateViewController(withIdentifier: "v3")
